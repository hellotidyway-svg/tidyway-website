...
const badges = [
  ...
  { icon: '📍', text: 'Serving London Since 2023' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight">
              <span className="text-white">
                The London cleaning service<br />that actually shows up.
              </span>
              <br />
              <span className="text-[#2DD4A7]">Here&apos;s what that means for you.</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
          {reasons.map(reason => (
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-[#2DD4A7] flex items-center justify-center mb-4">
                {reason.icon}
              </div>
